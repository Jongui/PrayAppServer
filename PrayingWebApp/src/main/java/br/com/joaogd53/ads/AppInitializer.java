...
public class AppInitializer implements WebApplicationInitializer {
	...
	public void onStartup(ServletContext servletContext) throws ServletException {
		...
		// map requests that you want the DispatcherServlet to handle, by using a URL
		// mapping
	...
	/**
	 * Ensure that all required @Configuration, @Controller and @Component classes
	 * are registered to the Spring application context.
	 */
